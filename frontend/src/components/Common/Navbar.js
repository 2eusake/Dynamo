...
// import { FaBell, FaBars, FaSearch, FaUserCircle } from "react-icons/fa";
...
//         <button className="relative p-2 hover:bg-gray-100 rounded-full transition-colors duration-200 focus:outline-none">
